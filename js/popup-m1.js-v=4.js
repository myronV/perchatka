...
$(function () {
    ...
    $('<div id="overlay-popup-m1"></div>' +
        ...
        '<input type="hidden" name="from_recall_button" value="0" /></form>' +
        '<div class="popup-m1-text2">Оператор перезвонит Вам через 5-10 минут</div></div></div></div>').insertAfter("body");
